...
public class DatabaseServer {
            ...
            while (!line.equals("Over"))
            {
                try
                {
                    if(!isAuthenticed){
                        line = in.readUTF();
                        while (!isAuthenticed){
                            appendLogFile("Alice->Database",line);
                            ...
                            if(recivedMessage.length == 3){
                                ...
                                appendLogFile("Database->Alice",Arrays.toString(noncePlusOne) + "," + Arrays.toString(nonceSecond));
                                ...
                                appendLogFile("Database->Alice",encryptedMessage);
                                ...
                                if(Arrays.equals(nonceSecondResponse,nonceSecondPlus)){
                                    appendLogFile("Database->Alice","Authentication is completed!");
                                    ...
                                    appendLogFile("Database->Alice","Authentication is failed!");
                                    out.writeUTF("Failed");
                                    out.flush();
                                    out = null;
                                    line = "Over";
                                ...
                                appendLogFile("Alice->Database","Authentication is failed!");
                                line = "Over";
                                break;
                            }
                        }
    ...
    public static String makeMessageDecrypted(String ticket, boolean isValid) throws Exception {
        KeyPair WebKey = KeyStoreJKS.getKeyPairFromKeyStore(System.getProperty("user.dir") + "/cert/","Database");
    ...
    public static void appendLogFile(String sender, String line) throws IOException {
        ...
        File logFile = new File("Database_Log.txt");
    ...
    public static void main(String args[]) throws Exception {
        DatabaseServer server = new DatabaseServer(3003);
    }
}
