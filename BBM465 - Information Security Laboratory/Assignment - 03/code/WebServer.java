...
public class WebServer {
                    ...
                    if(!isAuthenticed){
                        ...
                        while (!isAuthenticed){
                            ...
                            if(recivedMessage.length == 3){
                                ...
                                appendLogFile("Web->Alice",Arrays.toString(noncePlusOne) + "," + Arrays.toString(nonceSecond));
                                ...
                                appendLogFile("Web->Alice",encryptedMessage);
                                ...
                                if(Arrays.equals(nonceSecondResponse,nonceSecondPlus)){
                                    appendLogFile("Web->Alice","Authentication is completed!");
                                    ...
                                    appendLogFile("Web->Alice","Authentication is failed!");
                                    out.writeUTF("Failed");
                                    out.flush();
                                    out = null;
                                    line = "Over";
                                ...
                                appendLogFile("Alice->Web","Authentication is failed!");
                                line = "Over";
                                break;
                            }
                        }
    ...
    public static String makeMessageDecrypted(String ticket, boolean isValid) throws Exception {
        KeyPair WebKey = KeyStoreJKS.getKeyPairFromKeyStore(System.getProperty("user.dir") + "/cert/","Web");
    ...
    public static void appendLogFile(String sender, String line) throws IOException {
        ...
        File logFile = new File("Web_Log.txt");
    ...
    public static void main(String args[]) throws Exception {
        WebServer server = new WebServer(3002);
    }
}
